        ...
        sample_stories = [
            {
                ...
                'original_text': '''बिरसा मुंडा एक महान स्वतंत्रता सेनानी और आदिवासी नेता थे। उन्होंने अंग्रेजी शासन के खिलाफ लड़ाई लड़ी और अपने लोगों के अधिकारों के लिए संघर्ष किया। वह 'धरती आबा' (पृथ्वी के पिता) के नाम से प्रसिद्ध थे। आज भी झारखंड में उनकी वीरता और त्याग की कहानियां गाई जाती हैं।''',
            ...
            },
            {
                ...
                'original_text': '''ഓണം കേരളത്തിലെ ഏറ്റവും പ്രധാനപ്പെട്ട ഉത്സവമാണ്. രാജാവായ മഹാബലിയുടെ വാർഷിക വരവിനെ ആഘോഷിക്കുന്ന ഈ ഉത്സവം പത്ത് ദിവസം നീണ്ടുനിൽക്കുന്നു. വാമന അവതാരത്തിന്റെയും മഹാബലി രാജാവിന്റെയും കഥയാണ് ഈ ഉത്സവത്തിന് പിന്നിൽ. പൂക്കളം, സദ്യ, പുലികളി എന്നിവയാണ് ഓണത്തിന്റെ പ്രത്യേകതകൾ.''',
            ...
            },
            {
                ...
                'original_text': '''పెసరకు గిన్నె అట్టు తెలుగు వారి ప్రముఖ వంటకం. ముఖ్యంగా గణేశ చవిति రోజున చేస్తారు. పెసరపప్పు, బియ్యం కలిపి నానబెట్టి రాతిరోజుల వేసుకొని అట్లు చేస్తారు. వీటితో పచ్చి చట్నీ, కొబ్బరి చట్నీ తింటారు. ఈ అట్లు చాలా రుచిగా మరియు ఆరోగ్యకరంగా ఉంటాయి.''',
            ...
            },
            {
                ...
                'original_text': '''ஒரு மயில் மற்றும் ஒரு காகம் நண்பர்களாக இருந்தனர். மயில் தன் அழகான இறகுகளைப் பற்றி பெருமிதம் கொண்டிருந்தது. ஒரு நாள் பெரிய புயல் வந்தது. மயிலால் பறக்க முடியவில்லை, ஆனால் காகம் எளிதாக பறந்தது. இதனால் மயில் புரிந்து கொண்டது - அழகை விட திறமை முக்கியம்.''',
            ...
            },
            {
                ...
                'original_text': '''দুর্গাপূজা বাঙালিদের সবচেয়ে বড় উৎসব। এই সময় দেবী দুর্গা তার সন্তানদের নিয়ে মর্ত্যে আসেন। প্রতিটি পাড়ায় প্যান্ডেল তৈরি হয়। মানুষ নতুন কাপড় পরে, মিষ্টি খায়, আর পূজা দেখতে যায়। সবাই ঢাকের তালে তালে নাচে। এই পাঁচ দিনে বাঙালিরা সব দুঃখ ভুলে আনন্দে মেতে ওঠে।''',
